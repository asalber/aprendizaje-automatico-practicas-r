...
a.  Preprocesar el conjunto de entrenamiento convertir la variable respuesta, el diagnóstico, en una variable numérica y normalizar el resto de variables predictivas
...
a.  Construir una red neuronal con una capa oculta de 10 neuronas para predecir el diagnóstico.
